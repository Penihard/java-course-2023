...
class ConsoleHangman {
    ...
    private final String stopWord = "badBoy";
    ...
    public void run() throws IOException {
        ...
        while (true) {
            ...
            if (resultState == States.GIVE_UP || resultState == States.LOSE || resultState == States.WIN) {
                break;
            }
        }
    }
    ...
    private GuessResult giveUp() {
        GuessResult giveUpResult = this.session.giveUp();
        LOGGER.info(giveUpResult.message());
        return giveUpResult;
    }
